<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MovieUpdate.aspx.cs" Inherits="Comp229_TeamAssign.MovieUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="container page-context" style="">
        <label class="subtitle">Update Movie</label>
        <br />
        <hr />
        <br />
        <table id="tblMovieInfo" class="tblMovieInfo">
            ...
            <tr>
                <td colspan="2">
                    <asp:Button runat="server" ID="btnUpdate" Text="Update" OnClick="UpdateMovieBtn_Click" CssClass="btn btn-warning float-right" ValidationGroup="newMovie" />
                </td>
            </tr>
        </table>
    </div>
